...
```mermaid
graph TD
    A[Familias Tonales en Mayor] --> B[Familia Tónica]
    A --> C[Familia Subdominante]
    A --> D[Familia Dominante]

    B --> B1[I - Tónica]
    B --> B2[iii - Mediante]
    B --> B3[vi - Superdominante]

    C --> C1[ii - Supertónica]
    C --> C2[IV - Subdominante]
...
```mermaid
graph TD
    A[Familias Tonales en Menor Natural] --> B[Familia Tónica]
    A --> C[Familia Subdominante]
    A --> D[Familia Dominante]
    ...
    C --> C1[iv - Subdominante]
    C --> C2[iiø - Supertónica]
...
```mermaid
graph TD
    A[Cambios en las Familias Tonales] --> B[Escala Mayor]
    A --> C[Escala Menor Natural]
    A --> D[Escala Menor Armónica]
    A --> E[Escala Menor Melódica]

    B --> B1[Dominante fuerte: V mayor]
    C --> C1[Dominante débil: v menor]
    D --> D1[Dominante reforzada: V mayor]
    E --> E1[Subdominante brillante: IV mayor]
